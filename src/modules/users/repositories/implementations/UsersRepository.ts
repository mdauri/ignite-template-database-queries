...
export class UsersRepository implements IUsersRepository {
  ...
  async findUserByFullName({
    ...
    return await this.repository.query(`SELECT * FROM USERS WHERE LOWER(first_name) like LOWER($1) and LOWER(last_name) like LOWER($2)`,[first_name, last_name]); // Complete usando raw query
  }
}
